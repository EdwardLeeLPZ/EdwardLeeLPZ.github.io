...
- **Learnable $$α_{PE}$$ is Important:** Fixed-scale PE easily causes semantic instability or convergence difficulties, while a learnable α\_{PE} significantly improves L2 error, collision rate, and out-of-bounds rate.
